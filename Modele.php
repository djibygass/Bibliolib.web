...
abstract class Modele{
  ...
  private static function getdb(){
    ...
    if (self::$db == null){
      self::$db = new PDO("mysql:host=localhost;dbname=bibliolib","root","");
      //self::$db = new PDO("mysql:host=ipssisqbibliolib.mysql.db;dbname=ipssisqbibliolib","ipssisqbibliolib","IpssiBibliolib2021"); 
    }
    return self::$db;
  }
  /*
