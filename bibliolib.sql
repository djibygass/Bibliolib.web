...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  lun. 01 fév. 2021 à 09:51
...
(6, 'djiby', '$2a$11$ndwYG8aCYZmuAS2KITY1zOvvN1jnTJMqm5tZqTWFix5wA3lcbeajq'),
(2, 'jan', '123'),
(3, 'mickael', '123'),
(4, 'ADMIN', 'ADMIN'),
(5, 'randy', '$2a$11$l/bF1jr0EoQcUC9j3PzUXem5h1a38avWVgcLvIa2N1TO3CL63ycci');
...
(1, 'djiby', '$2a$11$ygn6g3pvwULZjntdz/D.HOWN40mScohuy8hOhkBkf5voHjCCMMN4a', 1, NULL),
(2, 'geebee', '$2y$10$CP0geqOGe.iYtch9yNChMuXA90XWZP/q3GF8cHUAMYIdJRCr/sAau', 0, NULL),
(3, 'ADMIN', '$2a$11$towVG6XePU4h2fDjvenw..Zuwhy7L6cZYqijd91r3sdPtl74yLDYy', 1, NULL),
...
INSERT INTO `admin_site` (`id_admin`, `login`, `mdp`) VALUES
(14, 'djibyy', '$2y$10$CP0geqOGe.iYtch9yNChMuXA90XWZP/q3GF8cHUAMYIdJRCr/sAau'),
(15, 'jan.s', '$2y$10$zgrWyOZfyNPG77/reNFHRe2Jxr4787IZnE.OC72WHYURBFH1ifWeG'),
(16, 'gerard', '$2y$10$uhstCfMGFXA2BGjov3OCB.j0RkLreEmAkE24aokRzDyP0NMo7QdyC'),
(17, 'didier', '$2y$10$nGWxqyhe1qgnPWvH.sIkCeW6zMut4zwiOgeHdHUeKMRAtIcgdyeD.'),
(18, 'Mickael', '$2y$10$AmZc6hk7f5claWT7.25FP.cg8MWgyaS3d0NW6MXlD2ZbgpsV7C0Ie'),
(19, 'yama', '$2y$10$ZkoocXnOPqANQn88KD9lcuj9TYIrevRueLwCK.AoPYofY62XUhZ42'),
(20, 'Ezek', '$2y$10$aQ5ir3joehv1i.WWOdJpKuW.w2cxSNyP5lF.eesyddyrTMIl.eBGm'),
(21, 'Remy', '$2y$10$2MJarP/okXzcatnN4UE78e/gy4yU28SW/3xtP4wXVmf/xiow474ku'),
(22, 'Léa', '$2y$10$xDw39mC4quVf6U5srJdFVueOlzAReCaVg0Eu5lYqmH.VIBNEjFbyu'),
(23, 'Diarra', '$2y$10$AlgoDtEQ9ts.Yl98FjxCIegv2b0VD.IIYfQBDmAgkXsPckCUXejc.'),
(24, 'Zeynab ', '$2y$10$rzdp6ElYhuJkuiFRJAb/F.Zp4oaMh6Y7MVFo6A9sH9oT6yfs88OrK'),
(25, 'azerty2', '$2y$10$nHLMZEbQ5J/s0FUcnjLTF.yr9E5sYgp1qQZWOgMl2F42hi8N8gqke'),
(26, 'mia', '$2y$10$TwiTJPyKLYEf6gO0CLAQMOTbRRkVcVcw.zxOS58IE3Lm3xwDCV88e');
...
(8, 8, 'Rue Pierre Larousse', 'Paris', 75014, NULL),
...
INSERT INTO `chatbox` (`id`, `id_sender`, `id_recipient`, `content`, `date_time`) VALUES
(33, 1, 3, 'azazazaz', '2021-01-21 12:41:09'),
(34, 1, 3, 'azazfdfvgfgeerfcdferfdfreredfd', '2021-01-21 12:41:22'),
(35, 1, 3, 'hey\r\n', '2021-01-21 12:55:05'),
(36, 1, 3, 'eee', '2021-01-21 12:55:08'),
(37, 3, 1, 'yoooo\r\n', '2021-01-23 20:15:25'),
(38, 1, 3, 'jey', '2021-01-23 22:16:30'),
(39, 1, 2, 'yoooo bien ?', '2021-01-23 22:22:32'),
(40, 1, 3, 'on est là', '2021-01-23 22:30:46'),
(41, 1, 3, 'dfdf', '2021-01-23 22:48:07');
...
(13, 'fdfd', 'dfdfd', 'sasuke', '$2y$10$XhAEzKXsV7S61U4/gUgGZecFySaAoefzWcQQGPCAY8uDBq4WSbPOO');
...
INSERT INTO `emprunter` (`id_clients`, `id_livres`) VALUES
(6, 8),
(6, 12),
(6, 13),
(6, 16),
...
(75, 'Mes recettes gourmandes et healthy par FatSecretFrance', 'Simples, visuelles, graphiques, des recettes 100 % gourmandise 0 % culpabilité\r\nComment équilibrer son alimentation ? Quels ingrédients privilégier pour retrouver la forme ? Comment se faire plaisir sans faire exploser le compteur à calories ? Retrouvez dans cet ouvrage conseils et recettes pour vous faire plaisir sans culpabiliser.', 0, 100, 48, 7, 'healthy.jpg');
INSERT INTO `livres` (`id_livres`, `titre`, `description`, `prix`, `quantite`, `id_auteurs`, `id_catLivres`, `photo`) VALUES
...
INSERT INTO `messages` (`id`, `prenom`, `nom`, `email`, `sujet`, `contenu`, `date_time`) VALUES
(1, 'test', 'test', 'test@tes.com', 'test', 'test', '2020-12-13 00:00:00'),
(2, 'test', 'test', 'test@tes.com', 'test', 'test', '2020-12-13 16:05:24'),
