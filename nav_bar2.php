...
<nav class="navbar navbar-expand-lg navbar-transparent bg-transparent">
  <a class="navbar-brand" href="espacemembre.php">BiblioB</a>
  ...
  <div class='bag'>
    <a href="monsac.php"><button type="button" class="btn btn-transparent"> <i class="fas fa-shopping-bag"></i></button></a>
  </div>
  ...
  <div class="dropdown-menu dropdown-menu-lg-right" aria-labelledby="dropdownMenuButton">
      <a class="dropdown-item" href="traitements/deconnexion.php">Déconnexion</a>
    </div>
</div>
</nav>
